...
$(function() {
	...
	$('button').click(function() {
		...
		if(operation == 'list'){
			...
			pageList();
			form.attr('action','${ctxPath}/boardModify/menubreadmodify');
		}
		form.submit();
...
<script src="${ctxPath}/resources/js/board/menuget.js"></script>
<script src="${ctxPath}/resources/js/reply/menuReplyService.js"></script>
<script src="${ctxPath}/resources/js/reply/menuReply.js"></script>
