	...
	<div class="row">
		<div class="col-12">
			<div class="card"> 
				...
				<div class="card-body">
					<div class="form-group mb-5" style="height:auto">
						<input type="text" value="${vo.bno}" name="bno" readonly="readonly" style="width:200px; float:left;" class="form-control mr-2"> 
						<input type="text" value="${vo.title}" name="title" style="width:860px; float:left;" class="form-control">
					</div>
