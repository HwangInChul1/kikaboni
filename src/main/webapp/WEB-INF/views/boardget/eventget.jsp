...
$(function() {
	...
	$('button').click(function() {
		...
		if(operation == 'list'){
			...
			pageList();
			form.attr('action','${ctxPath}/boardModify/eventmodify');
		}
		form.submit();
...
<script src="${ctxPath}/resources/js/board/eventget.js"></script>
<script src="${ctxPath}/resources/js/reply/eventReplyService.js"></script>
<script src="${ctxPath}/resources/js/reply/eventReply.js"></script>
