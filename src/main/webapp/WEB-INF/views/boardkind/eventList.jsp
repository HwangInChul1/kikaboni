...
<div class="container mt-2">
	<div class="text-center">
		...
		<button class="btn btn-outline-primary float-right mb-2 register">
			<a href="${ctxPath}/boardRegister/eventregister">글 작성</a>
		</button>
	</div>
	...
	<form action="${ctxPath}/boardkind/eventList" method="get" class="pageMove">
...
$(function() {	
	...
	$('.getmove').click(function(e) {
		...
		$('.fbno').append($('<input/>', {type:'hidden',name:'bno',value:getValue}))
				  .attr('action','${ctxPath}/board/eventList/get')
				  .attr('method','get')
				  .submit();
	})
